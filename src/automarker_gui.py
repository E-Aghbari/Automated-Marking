...
#    May 14, 2025 11:25:16 PM BST  platform: Windows NT
...
Accessing files across multiple drives may slow down the program due to increased I/O overhead.''')
        ...
        self.Label2.configure(text='''Choose the folder containing the cleaned original submissions.''')
        ...
        self.btnRunTest.place(relx=0.845, rely=0.44, height=26, width=77
                , bordermode='ignore')
        ...
        self.CheckTask2.place(relx=0.729, rely=0.22, relheight=0.264
        ...
        self.CheckTask4.place(relx=0.729, rely=0.659, relheight=0.264
        ...
        self.CheckTask1.place(relx=0.612, rely=0.22, relheight=0.264
                , relwidth=0.09, bordermode='ignore')
        ...
        self.CheckTask3.place(relx=0.612, rely=0.659, relheight=0.264
                , relwidth=0.09, bordermode='ignore')
        ...
        self.btnGetRunfolder = tk.Button(self.frameBtmRight)
        self.btnGetRunfolder.place(relx=0.015, rely=0.571, height=26, width=87
                , bordermode='ignore')
        self.btnGetRunfolder.configure(activebackground="#d9d9d9")
        self.btnGetRunfolder.configure(activeforeground="black")
        self.btnGetRunfolder.configure(background="#d9d9d9")
        self.btnGetRunfolder.configure(command=automarker_gui_support.btn_GetRunfolder)
        self.btnGetRunfolder.configure(disabledforeground="#a3a3a3")
        self.btnGetRunfolder.configure(font="-family {Segoe UI} -size 9")
        self.btnGetRunfolder.configure(foreground="#000000")
        self.btnGetRunfolder.configure(highlightbackground="#d9d9d9")
        self.btnGetRunfolder.configure(highlightcolor="#000000")
        self.btnGetRunfolder.configure(text='''Select Folder''')

        self.Label3 = tk.Label(self.frameBtmRight)
        self.Label3.place(relx=0.029, rely=0.209, height=21, width=374
                , bordermode='ignore')
        ...
        self.Label3.configure(text='''Choose the folder containing the prepared override scenarios''')

        self.Entry5 = tk.Entry(self.frameBtmRight)
        self.Entry5.place(relx=0.16, rely=0.593, height=20, relwidth=0.429
                , bordermode='ignore')
        ...
        self.Entry5.configure(textvariable=self.vEntry5)

        self.Label13 = tk.Label(self.top)
        self.Label13.place(relx=0.535, rely=0.935, height=40, width=283)
        ...
        self.Label13.configure(font="-family {Segoe UI} -size 10 -weight bold")
        ...
        self.Label13.configure(text='''REMINDER: Dont forget to move Images, 
...
class Toplevel2:
    def __init__(self, top=None):
        ...
        self.closebtn.place(relx=0.444, rely=0.925, height=26, width=57)
        ...
        self.Label5_1.place(relx=0.014, rely=0.02, height=19, width=179)
        ...
        self.Label8.place(relx=0.014, rely=0.078, height=51, width=686)
...
select that folder in the first entry.''')
        ...
        self.Label6_1.place(relx=0.014, rely=0.184, height=140, width=697)
...
When completed, a message box will notify you and display the location of the cleaned submissions.''')
        ...
        self.Label5_1_1.place(relx=0.014, rely=0.482, height=25, width=149)
        ...
        self.Label10.place(relx=0.014, rely=0.527, height=146, width=700)
...
version of the task and test files (e.g., Task_1.py, Task_2.py, Testing_1.py, Dummy.py, Helper.py, etc.).''')
        ...
        self.Label12.place(relx=0.014, rely=0.832, height=72, width=702)
        ...
        self.Label12.configure(text='''3. Run Test: Once everything is ready, choose the folder containing override scenarios (Original_Submissions, 
